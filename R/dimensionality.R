...
#' }
#'
#' @param arr KHIVA Array with the x-coordinates and y-coordinates of the input points (x in column 0 and y in column 1).
...
Paa <- function(arr, bins) {
  ...
  if (getDims(arr.tmp)[2] != 2 || getDims(arr.tmp)[3] != 1 || getDims(arr.tmp)[4] != 1)
    stop("The first argument should be a KHIVA Array with the x-coordinates and
...
#'
#' @param arr KHIVA Array whose dimension zero is the length of the time series.
...
#'
#' @param arr KHIVA Array with with the x-coordinates and y-coordinates of the input points (x in column 0 and y in column 1).
...
#'
#' @param arr KHIVA Array with the input time series.
